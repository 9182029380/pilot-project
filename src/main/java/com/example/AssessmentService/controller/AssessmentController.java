...
public class AssessmentController {
    ...
    @PostMapping
    public ResponseEntity<?> createAssessment(@RequestBody AssessmentDTO assessmentRequest) throws DataIntegrityViolationException {
    ...
    public Optional<Question> fetchques(@PathVariable Long qid) {
        return assessmentService.fetchQuestion(qid);
    }
